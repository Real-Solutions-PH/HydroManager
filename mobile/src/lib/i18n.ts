...
const en = {
	...
	home: {
		...
		crop_composition_title: "Active Crop Mix",
		crop_composition_center: "active plants",
		crop_composition_empty: "No active crops",
		phases_card_title: "Plant Phases",
		phases_total_label: "growing",
		phases_empty: "No plants tracked yet",
		phase_germinating: "Germinating",
		phase_true_leaves: "True Leaves",
		phase_transplanted: "Transplanted",
		phase_fruiting: "Harvest-bound",
...
const tl: typeof en = {
	...
	home: {
		...
		crop_composition_title: "Komposisyon ng Pananim",
		crop_composition_center: "aktibong halaman",
		crop_composition_empty: "Walang aktibong pananim",
		phases_card_title: "Yugto ng Halaman",
		phases_total_label: "lumalaki",
		phases_empty: "Wala pang halaman na sinusubaybayan",
		phase_germinating: "Sumisibol",
		phase_true_leaves: "Tunay na Dahon",
		phase_transplanted: "Nailipat",
		phase_fruiting: "Para sa Ani",
