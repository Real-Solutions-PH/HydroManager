...
const en = {
	...
	home: {
		...
		checkin_summary:
			"{tasks} tasks pending • {harvests} batches ready to check • {low} low stock",
		...
		alert_low_stock_title: "{name} Running Low",
		alert_low_stock_subtitle: "{stock} {unit} remaining — min: {min}",
		alert_harvest_ready_title: "{variety} Batch Ready to Check",
		alert_harvest_ready_subtitle: "Day {day} — Harvest window: Day 25–35",
		plants_count: "{n} plants",
		upcoming_harvests: "Upcoming Harvests",
		upcoming_phases: "Upcoming Phases",
		phase_due: "Due now",
		phase_no_eta: "No ETA",
		phase_card_a11y: "{variety} ready to advance to {phase}",
		see_all: "See all",
		days_left: "{n}d left",
		...
		qa_log_reading_sub: "Track pH, EC, water level",
...
const tl: typeof en = {
	...
	home: {
		...
		checkin_summary:
			"{tasks} gawain natitira • {harvests} batch handa nang suriin • {low} kulang na stock",
		...
		a11y_notifications: "Mga Abiso",
		a11y_profile: "Profile",
		alert_low_stock_title: "Kulang na ang {name}",
		alert_low_stock_subtitle: "{stock} {unit} natitira — min: {min}",
		alert_harvest_ready_title: "Handa nang Suriin ang Batch ng {variety}",
		alert_harvest_ready_subtitle: "Araw {day} — Bintana ng Ani: Araw 25–35",
		plants_count: "{n} halaman",
		upcoming_harvests: "Mga Paparating na Ani",
		upcoming_phases: "Mga Paparating na Yugto",
		phase_due: "Pwede na",
		phase_no_eta: "Walang ETA",
		phase_card_a11y: "Handa nang sumulong sa {phase} ang {variety}",
		...
		qa_log_reading_sub: "I-track ang pH, EC, tubig",
